...
namespace Homework6.Controllers
{
    public class productsController : Controller
    {
        ...
        public ActionResult Index(int? page, string searching)
        {
            ...
            db.products.Where(x => x.product_name.Contains(searching) || searching == null).ToList();
            var pageNumber = page ?? 1;
            var pageSize = 10;
            var products = db.products.OrderBy(x => x.product_name).ToPagedList(pageNumber, pageSize);
